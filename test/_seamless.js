  ...
  function immutableInit(config) {
    ...
    function isImmutable(target) {
      if (typeof target === 'object') {
        return (
          target === null ||
          Boolean(Object.getOwnPropertyDescriptor(target, immutabilityTag))
        )
      }
      else {
   ...
   */
    function merge(other, config) {
      ...
      function addToResult(currentObj, otherObj, key) {
        ...
        var mergerResult =
          merger && merger(currentObj[key], immutableValue, config)
        ...
        if (
          ...
          if (mergerResult) {
            ...
            deep &&
            isMergableObject(currentValue) &&
            isMergableObject(immutableValue)
          ) {
    ...
    function objectReplace(value, config) {
      ...
      if (value === null || typeof value !== 'object') {
        throw new TypeError(
          'Immutable#replace can only be invoked with objects or arrays, not ' +
    ...
    function objectSetIn(path, value, config) {
      if (!(path instanceof Array) || path.length === 0) {
        throw new TypeError(
          'The first argument to Immutable#setIn must be an array containing at least one "key" string.'
        )
      }
    ...
    function update(property, updater) {
      ...
      return Immutable.set(
        this,
        property,
        updater.apply(initialVal, [initialVal].concat(restArgs))
      )
    }
    ...
    function isReactElement(obj) {
      return (
        typeof obj === 'object' &&
        obj !== null &&
        (obj.$$typeof === REACT_ELEMENT_TYPE_FALLBACK ||
    ...
    function Immutable(obj, options, stackRemaining) {
      if (
        ...
        var instantiateEmptyObject = !prototype ||
    ...
    Immutable.asMutable = toStaticObjectOrDateOrArray(
      asMutableObject,
      asMutableArray,
      asMutableDate
    )
